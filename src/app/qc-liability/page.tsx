...
export const metadata: Metadata = {
  title: "SNAP QC liability calculator (7 CFR 275.23(d)(2)) — Axiom Foundation",
  description:
  ...
  return (
    <>
      <div className="px-5 pt-28 md:px-8 md:pt-32">
        <div className="mx-auto w-full max-w-[1280px] rounded-[6px] border border-[var(--color-rule)] bg-[var(--color-paper-elevated)] px-5 py-4 text-sm leading-6 text-[var(--color-ink-secondary)]">
